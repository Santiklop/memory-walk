...
const MILESTONES = [
  ...
  { id: 6,  x: 5100,  year: 'Age 21',   title: 'University graduation',       biome: 1, accent: '#C4B5FD' },
  { id: 7,  x: 6000,  year: 'Age 21',   title: 'First job post-uni',          biome: 1, accent: '#7DD3FC' },
  { id: 8,  x: 6900,  year: 'Age 24',   title: 'Wedding day',                 biome: 1, accent: '#FFC6D9', petals: true },
  { id: 9,  x: 7800,  year: 'Age 26',   title: 'Our daughter Anna is born',   biome: 1, accent: '#FFE6A7', glow: true },
  { id: 10, x: 8700,  year: 'Age 27',   title: 'Hello Belgium!',              biome: 2, accent: '#FDE68A', waffles: true },
  { id: 11, x: 9600,  year: 'Age 29',   title: 'Hello London!',               biome: 3, accent: '#FCA5A5' },
  { id: 12, x: 10500, year: 'Age 30',   title: 'Job at Vodafone',             biome: 3, accent: '#EF4444', bus: true },
  { id: 13, x: 11400, year: 'Age 31',   title: 'Hello Amsterdam!',            biome: 4, accent: '#FB923C' },
  { id: 14, x: 12300, year: 'Age 32',   title: 'Job at Coty',                 biome: 4, accent: '#A78BFA' },
  { id: 15, x: 13200, year: 'Age 35',   title: 'First apartment',             biome: 4, accent: '#86EFAC', keys: true },
