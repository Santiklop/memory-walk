...
const MILESTONES = [
  ...
  { id: 5,  x: 4200,  year: 'Age 20',   title: 'Meets her future husband',   biome: 1, accent: '#FF6B9D', hearts: true, growTo: 'adult' },
  { id: 6,  x: 5100,  year: 'Age 22',   title: 'University graduation',      biome: 1, accent: '#C4B5FD' },
  { id: 7,  x: 6000,  year: 'Age 23',   title: 'First job',                  biome: 1, accent: '#7DD3FC' },
  { id: 8,  x: 6900,  year: 'Age 25',   title: 'Wedding day',                biome: 1, accent: '#FFC6D9', petals: true },
  { id: 9,  x: 7800,  year: 'Age 27',   title: 'Our daughter is born',       biome: 1, accent: '#FFE6A7', glow: true },
  { id: 10, x: 8700,  year: 'Age 29',   title: 'Moves to Belgium',           biome: 2, accent: '#FDE68A', waffles: true },
  { id: 11, x: 9600,  year: 'Age 31',   title: 'Moves to London',            biome: 3, accent: '#FCA5A5' },
  { id: 12, x: 10500, year: 'Age 32',   title: 'Starts at Vodafone',         biome: 3, accent: '#EF4444', bus: true },
  ...
  { id: 16, x: 14200, year: 'Age 38',   title: 'Turns 38',                   biome: 4, accent: '#FFD86B', fireworks: true },
];
