...
const MILESTONES = [
  ...
  { id: 3,  x: 2400,  year: 'Age 17',   title: 'School graduation',           biome: 0, accent: '#FFB86B', growTo: 'teen_grad' },
  { id: 4,  x: 3300,  year: 'Age 17',   title: 'First year at university',    biome: 1, accent: '#F9A8D4', growTo: 'teen' },
